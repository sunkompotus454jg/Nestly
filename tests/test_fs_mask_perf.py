...
from PyQt6.QtGui import QFileSystemModel, QIcon, QRegion

class FastFileSystemModel(QFileSystemModel):
...
class TestWindow(QWidget):
    def __init__(self, target_path):
        ...
        self.model = FastFileSystemModel()
        ...
        self._anim_value = 50
        self.setMask(QRegion(0, 0, 500, self._anim_value))
    ...
    def anim_prop(self, value):
        ...
        self.frames += 1
        self.setMask(QRegion(0, 0, 500, value))
